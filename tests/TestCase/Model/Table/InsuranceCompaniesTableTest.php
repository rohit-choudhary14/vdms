...
class InsuranceCompaniesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('InsuranceCompanies') ? [] : ['className' => InsuranceCompaniesTable::class];
        $this->InsuranceCompanies = TableRegistry::getTableLocator()->get('InsuranceCompanies', $config);
    }
