...
<div class="card shadow-sm mb-4 mt-3">
    <div class="card-header bg-dark text-white">
        <h5 class="mb-0"><i class="fas fa-building me-2"></i>&nbsp;Edit Insurance Company</h5>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="col-12 text-end mt-3">
            <?= $this->Form->button('<i class="fas fa-save"></i> Update Company', [
                'escape' => false,
                'class' => 'btn btn-primary px-5 btn-lg shadow-sm'
            ]) ?>
        </div>
